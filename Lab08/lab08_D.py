...
def main():
    ...
    plt.imsave('resultD1.jpg', xray_denoised_A, cmap='gray')
    plt.imsave('resultD2.jpg', xray_denoised_B, cmap='gray')
    plt.imsave('resultD3.jpg', xray_denoised_C, cmap='gray')
    plt.imsave('resultD4.jpg', xray_denoised_D, cmap='gray')
    plt.imsave('resultD5.jpg', xray_denoised_E, cmap='gray')
    plt.imsave('resultD6.jpg', xray_denoised_F, cmap='gray')
    plt.imsave('resultD7.jpg', xray_denoised_G, cmap='gray')
